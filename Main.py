...
controller = PDController(setpoint=[.1, 0.350], kp=50.0, kd=50.0, dt=0.01)
...
while 1:
    ...
    packet.write2ByteTxRx(port, 6, 100, int(tau[0]*K_PWM) & 0xFFFF)
    packet.write2ByteTxRx(port, 5, 100, int(tau[1]*K_PWM) & 0xFFFF)

    print(f'force:{force}, torques:{tau}')
